...
`r ESMARConfName` is taking place from the `r format(as.Date(ESMARConf_startDate), "%d")` to the `r format(as.Date(ESMARConf_endDate), "%d %B")` online. Participants will be joining the conference through YouTube (watching individual pre-recorded talks and live streams) and Twitter (submitting questions).  
